...
;; J -dark blue !__
(define J (list (make-block (make-posn 4 22) "dark blue")
                (make-block (make-posn 4 21) "dark blue")
                (make-block (make-posn 5 21) "dark blue")
                (make-block (make-posn 6 21) "dark blue")))

;; L - orange
(define L (list (make-block (make-posn 6 22) "orange")
                (make-block (make-posn 4 21) "orange")
                (make-block (make-posn 5 21) "orange")
...
;; S - Green
(define S (list (make-block (make-posn 5 22) "green")
                (make-block (make-posn 6 22) "green")
                (make-block (make-posn 4 21) "green")
                (make-block (make-posn 5 21) "green")))
;; Z - Red
(define Z (list (make-block (make-posn 4 22) "red")
                (make-block (make-posn 5 22) "red")
                (make-block (make-posn 5 21) "red")
                (make-block (make-posn 6 21) "red")))
;; T - magenta
(define T (list (make-block (make-posn 5 22) "magenta")
                (make-block (make-posn 4 21) "magenta")
                (make-block (make-posn 5 21) "magenta")
